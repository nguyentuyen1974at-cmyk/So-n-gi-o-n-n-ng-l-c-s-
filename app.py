...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Tuyến - Trường  Tiểu học Hùng An - ĐT: 0946130274</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Tuyến - Trường Tiểu học An Tiến - ĐT: 0946130274</div>", unsafe_allow_html=True)
